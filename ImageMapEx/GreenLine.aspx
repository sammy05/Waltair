<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GreenLine.aspx.cs" Inherits="ImageMapEx.GreenLine" %>
...
<body>
    <form id="form1" runat="server" >
        ...
        <div id="imageDiv" class="w3-container" style="margin-left: 15%; margin-top: 0%;">
            <img id="mainImg" src="Image/Green color_Cropped.jpg" usemap="#image-map"/>
